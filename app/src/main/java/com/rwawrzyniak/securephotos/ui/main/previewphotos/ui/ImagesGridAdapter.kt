...
class ImagesGridAdapter @Inject constructor() :
	PagingDataAdapter<ImageModel, ImagesGridAdapter.ImageViewHolder>(DIFFER) {

	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ImageViewHolder =
		ImageViewHolder(
			LayoutInflater.from(parent.context)
				.inflate(R.layout.image_item_in_grid_layout, parent, false)
		)
...
internal class DiffCallback : DiffUtil.ItemCallback<ImageModel>() {
